...
test-application:
	node --test $(TEST_FLAGS) test/agent.test.js test/integration.test.js test/integration-scope.test.js test/popup.test.js test/popup-context.test.js test/popup-passkey.test.js test/popup-warnings.test.js
