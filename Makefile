...
.PHONY: test-modules
test-modules:
	node --test $(TEST_FLAGS) test/helpers.test.js test/plaintext.test.js test/schema.test.js test/selectors.test.js test/targets.test.js test/shadow.test.js test/webauthn.test.js test/parcel-webauthn.test.js
