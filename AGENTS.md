...
| `integration-harness.js` | Shared bootstrap harness used by the content-script test suites (not a test file itself). |
| `webauthn-integration.test.js` | Content script: WebAuthn/passkey ceremony bridge. |
