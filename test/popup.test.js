...
<ul id="entries"></ul>
<p id="passkey-note" class="list-notice hidden"></p>
...
describe("Popup script", { concurrency: false }, () => {
    ...
    test("match message toggles the passkey availability notice", async () => {
        ...
        assert.strictEqual(note.textContent, "Passkey available for this site");
        ...
        await settleAsync();
        assert.strictEqual(note.textContent, "2 passkeys available for this site");
