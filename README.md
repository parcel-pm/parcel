...
| `clipboardTimeout` | integer | `60` | Seconds before the host auto-clears a password copied via the privacy-enhancing clipboard action (1-3600). On Wayland, the copy also sets wl-copy's `--sensitive` hint when the installed wl-copy supports it. |
